...
public class TeacherSideMarkingAttendance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_side_marking_attendance);
       ...
       // ed3=findViewById(R.id.ed_date);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(TeacherSideMarkingAttendance.this, "Year "+Year+" "+semester+" "+subject+" "+rollno, Toast.LENGTH_SHORT).show();
                ...
                attendanceRef.setValue(attendance).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(TeacherSideMarkingAttendance.this, "Attendance marked successfully", Toast.LENGTH_SHORT).show();
                            }
                        })
                        .addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(TeacherSideMarkingAttendance.this, "Attendance marking failed", Toast.LENGTH_SHORT).show();
                            }
                        });
